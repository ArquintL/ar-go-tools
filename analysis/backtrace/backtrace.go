...
func Analyze(logger *config.LogGroup, cfg *config.Config, prog *ssa.Program,
	p []*packages.Package) (AnalysisResult, error) {
	...
	state, err := df.NewInitializedAnalyzerState(logger, cfg, prog, p)
	if err != nil {
